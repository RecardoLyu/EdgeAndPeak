                ...
                emxArray_boolean_T *B)
{
  ...
  strel b_obj;
  strel obj;
  double b_padSize_data[2];
  double padSize_data[2];
  double *allheight_data;
  int b_padSize_size[2];
  int padSize_size[2];
  int b_i;
  int i;
  int i1;
  ...
  strel_getpadsize(se_StrelArray, se_DecomposedStrelArray, padSize_data,
                   padSize_size, b_padSize_data, b_padSize_size);
  emxInit_boolean_T(&Apadpre, 2);
  i = Apadpre->size[0] * Apadpre->size[1];
  Apadpre->size[0] = (int)((double)A->size[0] + padSize_data[0]);
  Apadpre->size[1] = (int)((double)A->size[1] + padSize_data[1]);
  emxEnsureCapacity_boolean_T(Apadpre, i);
  Apadpre_data = Apadpre->data;
  i = (int)padSize_data[1];
  for (j = 0; j < i; j++) {
    i1 = Apadpre->size[0];
    for (b_i = 0; b_i < i1; b_i++) {
  ...
  i1 = (int)padSize_data[1] + 1;
  i2 = Apadpre->size[1];
  for (j = i1; j <= i2; j++) {
    offset = (int)padSize_data[0];
  ...
  for (j = 0; j < i1; j++) {
    for (b_i = 0; b_i < i2; b_i++) {
      Apadpre_data[(b_i + (int)padSize_data[0]) + Apadpre->size[0] * (j + i)] =
          A_data[b_i + A->size[0] * j];
    }
  }
  emxInit_boolean_T(&Apad, 2);
  i = Apad->size[0] * Apad->size[1];
  Apad->size[0] = (int)((double)Apadpre->size[0] + b_padSize_data[0]);
  i1 = (int)((double)Apadpre->size[1] + b_padSize_data[1]);
  Apad->size[1] = (int)((double)Apadpre->size[1] + b_padSize_data[1]);
  ...
  for (j = i; j <= i1; j++) {
    i2 = Apad->size[0];
    for (b_i = 0; b_i < i2; b_i++) {
      Apad_data[b_i + Apad->size[0] * (j - 1)] = false;
    }
  }
  i = Apadpre->size[1];
  i1 = Apadpre->size[0] + 1;
  ...
  for (j = 0; j < i; j++) {
    for (b_i = 0; b_i < i1; b_i++) {
      Apad_data[b_i + Apad->size[0] * j] =
          Apadpre_data[b_i + Apadpre->size[0] * j];
    }
  }
  ...
  if (pre_pack) {
    ...
    b_padSize_data[0] = Apadpack->size[0];
    padSize_data[1] = Apad->size[1];
    b_padSize_data[1] = Apad->size[1];
    bwPackingtbb(&Apad_data[0], &padSize_data[0], &Apadpack_data[0],
                 &b_padSize_data[0], true);
    Apad->size[0] = 0;
    Apad->size[1] = 0;
  } else {
    numRows = -1;
    ...
    if (pre_pack) {
      ...
      if (libNameEnum == 5) {
        if (fcnNameEnum == 10) {
          ...
          padSize_data[1] = Apad->size[1];
          nsizeT_data[1] = nhood->size[1];
          dilate_binary_ones33_tbb(&Apad_data[0], &padSize_data[0], 2.0,
                                   &nhood_data[0], &nsizeT_data[0], 2.0,
                                   &Apadpre_data[0]);
          ...
          padSize_data[1] = Apad->size[1];
          nsizeT_data[1] = nhood->size[1];
          dilate_binary_twod_tbb(&Apad_data[0], &padSize_data[0], 2.0,
                                 &nhood_data[0], &nsizeT_data[0], 2.0,
                                 &Apadpre_data[0]);
          ...
          padSize_data[1] = Apad->size[1];
          nsizeT_data[1] = nhood->size[1];
          dilate_binary_tbb(&Apad_data[0], &padSize_data[0], 2.0,
                            &nhood_data[0], &nsizeT_data[0], 2.0,
                            &Apadpre_data[0]);
        }
        ...
        padSize_data[1] = Apad->size[1];
        nsizeT_data[1] = nhood->size[1];
        dilate_binary_tbb(&Apad_data[0], &padSize_data[0], 2.0, &nhood_data[0],
  ...
  if (pre_pack) {
    if ((Bpack->size[0] == 0) || (Bpack->size[1] == 0)) {
      ...
      emxEnsureCapacity_boolean_T(B, i);
      Apadpre_data = B->data;
      b_padSize_data[0] = Bpack->size[0];
      padSize_data[0] = numRows;
      b_padSize_data[1] = Bpack->size[1];
      padSize_data[1] = Bpack->size[1];
      bwUnpackingtbb(&Bpack_data[0], &b_padSize_data[0], &Apadpre_data[0],
                     &padSize_data[0], true);
    }
  }
