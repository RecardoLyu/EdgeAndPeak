 ...
 * File: _coder_cell_boundary_info.c
 *
...
/* Include Files */
#include "_coder_cell_boundary_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("cell_boundary"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString("D:\\ws_Matlab\\EdgeAndPeak\\cell_boundary.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739665.607662037));
  emlrtSetField(xEntryPoints, 0, "Constructor",
                emlrtMxCreateLogicalScalar(false));
  emlrtSetField(xEntryPoints, 0, "Visible", emlrtMxCreateLogicalScalar(true));
  xInputs = emlrtCreateLogicalMatrix(1, 2);
  emlrtSetField(xEntryPoints, 1, "Name",
                emlrtMxCreateString("cell_brightzone"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString("D:\\ws_Matlab\\EdgeAndPeak\\cell_brightzone.m"));
  emlrtSetField(xEntryPoints, 1, "TimeStamp",
                emlrtMxCreateDoubleScalar(739665.67245370371));
  ...
  emlrtSetField(xResult, 0, "Version",
                emlrtMxCreateString("23.2.0.2668659 (R2023b) Update 9"));
...
/*
 * File trailer for _coder_cell_boundary_info.c
 *
 * [EOF]
 */
