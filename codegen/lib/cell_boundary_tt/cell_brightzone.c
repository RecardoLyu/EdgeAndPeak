                     ...
                     emxArray_boolean_T *peak_mask)
{
  ...
  /*  Laplacian filter */
  b_imfilter(img_tophat, img_lap1);
  imbinarize(img_lap1, b_peak_mask);
  e_emxInit_images_internal_coder(&SE_StrelArray);
  emxInit_cell_wrap_1(&SE_DecomposedStrelArray);
  b_strel_strel(strel_size, SE_StrelArray, SE_DecomposedStrelArray);
  e_imerode(b_peak_mask, SE_StrelArray, SE_DecomposedStrelArray, peak_mask);
  peak_mask_data = peak_mask->data;
  b_strel_strel(strel_size - 1.0, SE_StrelArray, SE_DecomposedStrelArray);
  ...
  f_imdilate(c_peak_mask, SE_StrelArray, SE_DecomposedStrelArray, peak_mask);
