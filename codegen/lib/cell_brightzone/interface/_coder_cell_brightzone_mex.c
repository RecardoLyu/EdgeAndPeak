 ...
 * File: _coder_cell_brightzone_mex.c
 *
...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&cell_brightzone_atexit);
  /* Module initialization. */
  cell_brightzone_initialize();
  /* Dispatch the entry-point. */
  unsafe_cell_brightzone_mexFunction(nlhs, plhs, nrhs, prhs);
  /* Module termination. */
  cell_brightzone_terminate();
}
...
/*
 * File trailer for _coder_cell_brightzone_mex.c
 *
 * [EOF]
 */
