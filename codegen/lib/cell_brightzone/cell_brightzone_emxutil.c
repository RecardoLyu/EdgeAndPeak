 ...
 * File: cell_brightzone_emxutil.c
 *
...
/*
 * Arguments    : emxArray_cell_wrap_26 *emxArray
 *                int oldNumel
 * Return Type  : void
 */
void emxEnsureCapacity_cell_wrap_26(emxArray_cell_wrap_26 *emxArray,
                                    int oldNumel)
{
  int i;
  int newNumel;
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = calloc((unsigned int)i, sizeof(cell_wrap_26));
    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data,
             sizeof(cell_wrap_26) * (unsigned int)oldNumel);
      if (emxArray->canFreeData) {
        free(emxArray->data);
      }
    }
  ...
  if (oldNumel > newNumel) {
    ...
    emxExpand_cell_wrap_26(emxArray, oldNumel, newNumel);
  }
}
 ...
 * Return Type  : void
 */
void emxExpand_cell_wrap_26(emxArray_cell_wrap_26 *emxArray, int fromIndex,
                            int toIndex)
{
  int i;
  for (i = fromIndex; i < toIndex; i++) {
    emxInitStruct_cell_wrap_26(&emxArray->data[i]);
  }
}

/*
 * Arguments    : cell_wrap_27 pMatrix[3]
 * Return Type  : void
 */
void emxFreeMatrix_cell_wrap_27(cell_wrap_27 pMatrix[3])
{
  int i;
  for (i = 0; i < 3; i++) {
    emxFreeStruct_cell_wrap_27(&pMatrix[i]);
  }
}
...
/*
 * Arguments    : cell_wrap_27 *pStruct
 * Return Type  : void
 */
...
/*
 * Arguments    : emxArray_cell_wrap_26 **pEmxArray
 * Return Type  : void
 */
 ...
 * Return Type  : void
 */
void emxInitMatrix_cell_wrap_27(cell_wrap_27 pMatrix[3])
{
  int i;
  for (i = 0; i < 3; i++) {
    emxInitStruct_cell_wrap_27(&pMatrix[i]);
  }
}
 ...
 * Return Type  : void
 */
void emxInitStruct_cell_wrap_26(cell_wrap_26 *pStruct)
{
 ...
 * Return Type  : void
 */
void emxInitStruct_cell_wrap_27(cell_wrap_27 *pStruct)
{
 ...
 * Return Type  : void
 */
void emxInit_cell_wrap_26(emxArray_cell_wrap_26 **pEmxArray)
{
  emxArray_cell_wrap_26 *emxArray;
  int i;
  *pEmxArray = (emxArray_cell_wrap_26 *)malloc(sizeof(emxArray_cell_wrap_26));
  emxArray = *pEmxArray;
 ...
 * Return Type  : void
 */
void emxTrim_cell_wrap_26(emxArray_cell_wrap_26 *emxArray, int fromIndex,
                          int toIndex)
{
  int i;
  for (i = fromIndex; i < toIndex; i++) {
...
/*
 * File trailer for cell_brightzone_emxutil.c
 *
 * [EOF]
 */
